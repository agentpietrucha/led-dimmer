...
var Slider = /*#__PURE__*/utils.forwardRefWithAs(function Slider(_ref, forwardedRef) {
  ...
  }), React.createElement(SliderTrack, null, React.createElement(SliderRange, null), React.createElement(SliderHandle, null), children));
});
...
var SliderTrackHighlightImpl = /*#__PURE__*/utils.forwardRefWithAs(function SliderTrackHighlightImpl(props, ref) {
  {
    ...
    React.useEffect(function () {
       utils.warning(false, "`SliderTrackHighlight` has been deprecated in favor of `SliderRange` and will be dropped from a future version of Reach UI.") ;
    }, []);
  }

  return React.createElement(SliderRangeImpl, Object.assign({
